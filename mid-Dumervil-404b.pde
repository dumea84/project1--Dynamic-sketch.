// Alexander Dumervil CST 112 Midterm
// mid-Dumervil-404b.pde
...
void scene()
{
  ...
  //--  fill (random(53), random(200), random(20) );
  fill (random(50,60), random(80,120), random(20) );
  stroke (0, 255, 0);
  //--  rect(0, 200, 600, 300);
  rect(0, height*2/5, width, height*3/5);
  grass();
}
void grass()
{
    fill(#FFFF00);
    for(float xgreen= 0; xgreen<width; xgreen = xgreen + spacing)
    {
      line( xgreen, height, xgreen, height-50);
    }
}
...
void messages()
{
    ...
    //textSize(15);
    text("Alexander Dumervil", 40, 490);
...
void showfish()
{
  ...
  {
    fill(255, 255, 255);
    if (dxfish<0) xeye=  xfish-30;
    ellipse(xeye, yfish -5, 10, 10);
  }
  ...
  fill(255, 39, 64);
    stroke(255, 39, 64);
    line(xeye -10, yfish +10, xfish +35, yfish +10);
  }
}
...
//// Show the crab at bottom.  body, claws, feet, tail, etc.
void showcrab()
{
  // crab body
  {
